...
At first we assume that we have no additional knowledge.

The first step is to understand what do we mean by the effect of $X$ on $Y$. Here the implicit question is **if I set the value of $X$ to 1 how will I affect the value of $Y$**
